...
public class NzbFileListPopupMoveBottomAction extends AbstractAction 
{	
	...
	public NzbFileListPopupMoveBottomAction(HelloNzb f, int selectedRow)
	{
		this.mainApp = f;
	...
	{
		mainApp.moveRowsToBottomNzbQueue(selectedRow);
