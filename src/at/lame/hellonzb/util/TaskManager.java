	...
	public void run()
	{
		...
		while(!shutdown)
		{
			if(!activeRar.isEmpty())
			{
				...
				if(currState != 5)
				{	
					changeProgBar(Main.localer.getBundleText("StatusBarArcExtracting"), true);
					currState = 5;
				}
			}
			else if(!activePar2.isEmpty())
			{
				...
				if(currState != 4)
				{	
					changeProgBar(Main.localer.getBundleText("StatusBarPar2Check"), true);
					currState = 4;
				}
			}
			else if(activeNzbLoading)
			{
				...
				if(currState != 3)
				{	
					changeProgBar(Main.localer.getBundleText("StatusBarOpeningNzbFile"), true);
					currState = 3;
				}
			}
			else if(activeLoadSession)
			{
				...
				if(currState != 2)
				{	
					changeProgBar(Main.localer.getBundleText("StatusBarLoadingLastSession"), true);
					currState = 2;
				}
			}
			else if(activeUpdateCheck)
			{
				...
				if(currState != 1)
				{	
					changeProgBar(Main.localer.getBundleText("StatusBarUpdateCheck"), true);
					currState = 1;
				}
			}
			else
